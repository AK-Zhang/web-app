    ...
    <div class="user_login">
      <form class="mui-input-group">
        ...
        <div class="mui-input-row mui-plus-hidden">
          ...
          <input type="text" class="mui-input-speech mui-input-clear" v-model="verifyCode" placeholder="请输入验证码" data-input-clear="4" data-input-speech="4">
        ...
        <!-- <div class="mui-input-row mui-plus-hidden">
                <label><span class="iconfont icon-mimaqueren"></span></label>
      ...
      <div class="mui-content-padded">
        <button id='login' class="mui-btn mui-btn-block mui-btn-danger" @click="useRegister">提交</button>
        <!-- <div class="link-area">
  ...
  methods: {
    ...
    useRegister() {
      if (this.tel.length == 0) {
        ...
        var url = common.apidomain + "/api/Account/ForgetPassword";
        var postData = {
          Phone: this.tel,
          Password: this.pwd,
...
.template .user_login .mui-input-group .mui-input-row:nth-of-type(2) label span,
.template
  .user_login
  .mui-input-group
  .mui-input-row:nth-of-type(3)
  label
  span {
  font-size: 18px;
  padding-left: 3px;
...
.template .user_login .mui-input-group .mui-input-row:nth-of-type(2) .getcode {
  position: absolute;
  right: 15px;
  bottom: 8px;
  color: #0e6aff;
